...
<form className="flex m-4 " onSubmit={handleSubmit} >
  <input id="location" className="text-[#8EFF8B]  bg-transparent min-w-[150px] w-[200px] border-1 border-[#8EFF8B]" min={1} max={126} placeholder="Type a Location id..." type="number" />
